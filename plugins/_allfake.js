...
handler.all = async function (m) {
   ...
   global.pu = pp
	...
	global.kontak2 = [
	[owner[0], await conn.getName(owner[0] + '6281361598018@s.whatsapp.net'), 'ᴅᴇᴠᴇʟᴏᴩᴇʀ ʙᴏᴛ', 'agus12@gmail.com', true],
	[owner[1], await conn.getName(owner[1] + '@s.whatsapp.net'), 'ᴅᴇᴠᴇʟᴏᴩᴇʀ ʙᴏᴛ', 'agus12@gmail.com', true], ]
