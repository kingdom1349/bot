...
⬡ Upload: ${publishedTime}
⬡ Link: ${vid.url}
╰────────⬣`, author.trim(), await( await conn.getFile(thumbnail)).data, ['📽VIDEO', `${usedPrefix}getvid ${url} 360`], false, { quoted: m, 'document': { 'url':'https://wa.me/13342754744' },
...
body: wm,
sourceUrl: 'http://wa.me/13342754744', thumbnail: await ( await conn.getFile(thumbnail)).data
  }
 } 
})
